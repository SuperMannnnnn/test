...
import com.dabao.pictruestore.util.SystemUiHider;
...
public class FullscreenActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final View btnCome = findViewById(R.id.dummy_button);
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					Thread.sleep(3000);
					Intent intent = new Intent(FullscreenActivity.this,PictureActivity.class);
